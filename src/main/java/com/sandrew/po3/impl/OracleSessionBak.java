 ...
 * @version    :
 */
public class OracleSessionBak extends DefaultSessionBak
{
//	private NativeJdbcExtractor nativeJdbcExtractor;

	private static Logger logger = LogManager.getLogger(OracleSessionBak.class);
	 ...
	 * @param timeout
	 */
	private OracleSessionBak(String dbName, String txnName, NativeJdbcExtractor extractor, int timeout)
	{
		super(dbName, txnName, extractor, timeout);
	}

	public OracleSessionBak()
	{
	 ...
	 * @return
	 */
	public static OracleSessionBak getInstance(String dbName, String txnName, NativeJdbcExtractor extractor, int timeout)
	{
		return new OracleSessionBak(dbName, txnName, extractor, timeout);
	}
